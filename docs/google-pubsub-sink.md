...
- Download the NAR package from [the download page](https://github.com/streamnative/pulsar-io-google-pubsub/releases/download/v3.0.0.2-SNAPSHOT/pulsar-io-google-pubsub-3.0.0.2-SNAPSHOT.nar).
